...
ta = {
    "min_questionable":"250", 
    "min_acceptable":"800", 
    "max_acceptable":"2500", 
    "max_questionable":"2600"
}
ph = {
    "min_questionable":"7", 
    "min_acceptable":"7.2", 
...
def get_flag(var, value):
    ...
    if not value:
        flag=9
    elif fval < range['min_acceptable'] or fval > range['max_acceptable']:
        flag=3
    elif fval < range['min_questionable'] or fval > range['max_questionable']:
        flag=4
    return flag
